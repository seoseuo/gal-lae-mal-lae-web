...
public interface TourSpotsRepository extends JpaRepository<TourSpots, Integer> {
        ...
        Page<TourSpots> findByLsIdxAndC1CodeAndTsName(
                @Param("ldIdx") int ldIdx,
                @Param("lsIdx") int lsIdx,
                @Param("c1Code") String c1Code,
        ...
        Page<TourSpots> findByLdIdxAndC1CodeAndTsName(
                @Param("ldIdx") int ldIdx,
                @Param("c1Code") String c1Code,
                @Param("tsName") String tsName,
                Pageable pageable
